...
// static size_t u32_to_8_offset[4] = {3, 4, 5, 6};
...
//    uint8_t **CastToUint8Pointer(size_t offset) {
//        return uint8_ptr+offset;
//    }

//    void InitialUint8Poninter() {
//        // TODO, suport little endian
//        uint8_ptr = new uint8_t *[size_ * sizeof(uint32_t)];
//        uint8_t *data = reinterpret_cast<uint8_t *>(bits_);
//        size_t uint8_size = size_ * sizeof(uint32_t), i = 0;
//        while (i < uint8_size) {
//            uint8_ptr[i] = data + (i + 3 - (i % 4) * 2);
//            i++;
//        }
//    }
