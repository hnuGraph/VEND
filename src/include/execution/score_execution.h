...
static constexpr int PLAN_NUMS = 2;
static VendType Vends[7] = {VendType::BBloomFilter, VendType::CBloomFilter, VendType::Hybrid, VendType::BloomFilterBit,
                            VendType::BloomFilterInt, VendType::Range,
                            VendType::HashBit};
